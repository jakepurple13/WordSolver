 ...
 */
enum class Theme(private val light: ColorScheme, private val dark: ColorScheme) {
    Default(LightColorScheme, DarkColorScheme) {
        override fun getTheme(darkTheme: Boolean, context: Context, dynamicColor: Boolean): ColorScheme {
            return when {
    ...
    NoDynamic(LightColorScheme, DarkColorScheme) {
        override fun getTheme(darkTheme: Boolean, context: Context, dynamicColor: Boolean): ColorScheme {
            return when {
                darkTheme -> DarkColorScheme
                else -> LightColorScheme
